...
export default function RegisterPromote() {
  return (
    <div className='flex w-full flex-col space-y-5 sm:flex-row sm:space-x-10 sm:space-y-0'>
      <div className='relative flex min-h-[260px] flex-col rounded-md bg-gray-800 p-5 text-black text-white sm:w-[85%]'>
        ...
        <button
          ...
          className='absolute bottom-5 w-[80%] self-center rounded-lg bg-primary px-3 py-2 text-center text-sm font-medium text-black hover:bg-primary-dark hover:text-white'
        >
          Switch to Customer
        </button>
      </div>
